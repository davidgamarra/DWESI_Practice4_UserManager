<?php
	...
	$asunto = "Password Recovery Log In Account";
	$mensaje = "https://correo-davidgamarra.c9users.io/passrec.php?email=".$destino."&code=".sha1($destino.Constant::SEED);
	...
	if ($cliente->getAccessToken()) {
		...
		echo "Correo de recuperacion enviado correctamente, revisa tu correo para recuperar la password";
